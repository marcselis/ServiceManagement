...
namespace ServiceManagement.Api
{
    ...
    public class Startup
    {
        ...
        /// </summary>
        /// <param name="app">
        /// An <see cref="IApplicationBuilder"/> instance that you can use to configure the application.
        /// </param>
        /// <param name="env">
        /// An <see cref="IWebHostEnvironment"/> instance that contains information about the
        /// environment the application is running in.
        /// </param>
        /// <param name="provider">
        /// An <see cref="IApiVersionDescriptionProvider"/> that provides information about versions
        /// this API supports.
        /// </param>
        ...
        /// </summary>
        /// <param name="services">
        /// A <see cref="IServiceCollection"/> instance that contains the registerd services.
        /// </param>
